<template>
  ...
  <section id="intro-wrap" class="intro-four-Wrap  text-left text-white">
    <b-container>
      <b-row>
        <b-col md="6" class="intro-four-LeftSection pb-5">
          <h1 class=" font-weight-bold text-white text-42 mb-3 t-shadow">
            A Place to Keep your Projects secure
          </h1>
          <p class=" text-20 mb-4">
            Meet Dexam Highly customizable Pure Vue JS + Bootstrap 4 Landing
            Pages.
          </p>
          <div class=" mb-5 lead">
        ...
        <b-col md="6"
          class="intro-four-RightSection d-flex align-items-center"
        >
          <div class="intro-four-ProductImage">
            <img
              src="@/assets/images/landing/svg/v4-header.svg"
