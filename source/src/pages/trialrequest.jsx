...
const TrialRequestPage = ({ pageContext, location, data }) => {
    return (
        <Layout location={location}>
            ...
            <main className="site-wrapper-reveal">
                ...
                <IframeArea data={data.allContentfulPage.nodes[0].content[1]?.link?.[0].value} width="100%" height="1500px" />
...
export const query = graphql`
    query TicketPageQuery($language: String!) {
        ...
        allContentfulPage(filter: {node_locale: {eq: $language}, key: {eq: "TrialRequest"}}) {
            nodes {
            title
            description {
                description
